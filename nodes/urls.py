...
urlpatterns = [
    ...
    url(r'^(?P<from_node_id>[0-9]+)/connect/(?P<to_node_id>[0-9]+)$', views.connect, name='connect'),
    url(r'^(?P<from_node_id>[0-9]+)/disconnect/(?P<to_node_id>[0-9]+)$', views.disconnect, name='disconnect'),
    url(r'^all/start$', views.start_all, name='start_all'),
